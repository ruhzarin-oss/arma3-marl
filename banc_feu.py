...
BRAS = ["REF", "SANSFEU"]
PAR_BLOC, BLOCS = 4, 5          # 20 manches de plus : 10 par bras -> 16 au total
RID0 = 0
SORTIE = os.environ.get("SORTIE", "/home/younes/arma3-marl/logs_train/banc_feu.jsonl")
...
ORDRES = {
    "REF": ('A3C_ai_shared_fnc_actionClearBuilding = compile preprocessFileLineNumbers "acb_ref.sqf";'
            'diag_log format ["HMT_VARIANTE REF taille=%1", count (str A3C_ai_shared_fnc_actionClearBuilding)];'
            '[HMT_ATT, HMT_BLD] call A3C_ai_shared_fnc_actionClearBuilding;'),
    "SANSFEU": ('A3C_ai_shared_fnc_actionClearBuilding = compile preprocessFileLineNumbers "acb_sansfeu.sqf";'
                'diag_log format ["HMT_VARIANTE SANSFEU taille=%1", count (str A3C_ai_shared_fnc_actionClearBuilding)];'
                '[HMT_ATT, HMT_BLD] call A3C_ai_shared_fnc_actionClearBuilding;'),
    ...
    "SCRIPT": '{ private _u = _x; private _i = HMT_ATT find _u; _u doMove (HMT_HAUT select (_i % (count HMT_HAUT))) } forEach HMT_ATT;',
}
