# Tache Windows HMT_DIABLE : un tour du diable toutes les 5 minutes. Le tour tourne dans WSL ; s il demande de
...
$log = 'C:\hmt\logs\diable.log'
New-Item -ItemType Directory -Force -Path 'C:\hmt\logs' | Out-Null
$out = & wsl.exe -u younes -- bash /mnt/data/hmt/depot/diable/tick.sh 2>&1
