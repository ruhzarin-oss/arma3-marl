"""paros (theatre Paros) — derive de maneuvers — RÉPERTOIRE DOCTRINAL CODÉ [pile 1/5, voie « école de guerre »]. Chaque manœuvre militaire
...
# --- geographie PAROS (ville de colline, ancree sur recon_paros : terre + LOS verifies) ---
