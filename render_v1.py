...
DEV = "cuda:0"
CKPT = "/home/younes/compose-embodiment/hostage_v1_FINAL.pt"   # d6 fige = livrable v1
D = 6

probe = HostageEnv(num_envs=1, A=9, D=D, device=DEV, seed=0)
...
for seed in range(40):
    env = HostageEnv(num_envs=1, A=9, D=D, device=DEV, seed=seed)
...
imageio.mimwrite("/home/younes/compose-embodiment/hostage_v1_rescue.mp4", chosen, fps=8, macro_block_size=1)
print("VIDEO %d frames -> hostage_v1_rescue.mp4" % len(chosen), flush=True)
