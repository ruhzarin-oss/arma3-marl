...
def sched(it):
    return 0.0, 0.0, "BASE infil+recup (DE ZERO, D=3)"   # diagnostic : env actuel, sans fragilite, sans warm-start
...
def train(iters=150, envs=4096, rollout=24, D=3):
    ...
    net = Net(O, NA, 512, 3).to(DEV)   # DE ZERO : pas de warm-start (test diagnostic)
