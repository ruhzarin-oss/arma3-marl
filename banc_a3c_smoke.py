...
HMT_C = [CX_, CY_, 0];
private _best = objNull; private _bn = 0;
{ private _n = count (_x buildingPos -1); if (_n > _bn) then { _bn = _n; _best = _x } } forEach (nearestObjects [HMT_C, ["House"], 300]);
HMT_BLD = _best;
