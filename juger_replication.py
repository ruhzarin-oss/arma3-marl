...
# REPLICATION INDEPENDANTE. Corpus fige au franchissement du seuil depose
# (>= 150 accrochages clos), cf. CRITERES_REPLICATION_AB.md. Une seule lecture.
JOURNAUX = ['/mnt/data/harmattan-sandbox/logs/serverBA_replication.out']
