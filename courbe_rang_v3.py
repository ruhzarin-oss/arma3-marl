...
NDUEL, DUREE = 54, 20
SORTIE = "/home/younes/arma3-marl/courbe_rang1_10_v3.json"
DIST_L = [25, 50, 75, 100, 150, 200]
POST_L = ["UP", "MIDDLE", "DOWN"]
MANQUE = [(100, "UP"), (100, "DOWN"), (150, "UP"), (150, "DOWN"),
          (200, "UP"), (200, "MIDDLE"), (200, "DOWN")]
COND = [c for c in MANQUE for _ in range(7)][:54] + [MANQUE[0]] * (54 - len([c for c in MANQUE for _ in range(7)][:54]))
RANG_MAX = 10
...
# ⛔ DEFAUT D INSTRUMENT TROUVE LE 04/09 : le tampon du pont est une deque de 50 000 lignes.
# A ~2 600 lignes par bloc il DEBORDE, les anciennes sont evincees, et une lecture par INDEX
# (`lines[n0:]`) devient fausse : le cumul a GELE a 33 352 pendant quatre blocs, qui n ont donc
# rien rapporte. On VIDE le tampon avant chaque bloc au lieu de le trancher par index.
