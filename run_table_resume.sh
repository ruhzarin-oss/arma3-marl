#!/bin/bash
# REPRISE de la table (07/06) : M1-M4 déjà mesurées (64 ops dans le jsonl, préservées).
# Boot 16 serveurs puis mesure M5, M6, M7 en APPEND. Ne touche pas aux données existantes.
...
print("\n[baseline opérationnelle = M1 mesurée ici, pas le 72% historique]")
PYEOF
echo "############ FIN TABLE (reprise) ############"
