...
# le vrai juge : l imagination d AVANT chaque iteration de l Oracle, sur cette iteration
for it in ("DIABLE-I001", "DIABLE-I002"):
    Ea = Dn.utilisables(Dn.episodes(lambda c, it=it: (not str(c).startswith(("DIABLE-I", "ORACLE-I"))) or (str(c) < it)))
