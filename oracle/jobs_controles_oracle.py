"""CONTROLES-ORACLE-20-09 ( criteres : oracle/CRITERES_CONTROLES_ORACLE.md, ecrits avant ).
...
for ctrl, (nom, jour) in BRAS.items():
    for s in (1, 2):
        for paire in PAIRES:
            L.append(dict(g, campagne="CONTROLES-ORACLE-20-09", graines=paire, situation=s, menace_p2=4,
                          ...
                          version=f"CTRL-{nom}-s{s}-g{paire[0]}g{paire[1]}",
