    ...
    phases = [
        ...
        {"name": "MISE_EN_PLACE",
         ...
         "contingencies": [{"if": ("losses", 0.35), "reason": "pertes avant assaut", "goto": "EXFIL"},
                           {"if": ("steps", 135), "reason": "mise en place trop lente", "goto": "ASSAUT"}]},
        {"name": "ASSAUT",
        ...
        {"name": "ASSAUT_RENFORCE",
         ...
         "contingencies": [{"if": ("losses", 0.5), "reason": "assaut renforcé trop coûteux", "goto": "EXFIL"},
                           {"if": ("steps", 165), "reason": "assaut renforcé enlisé", "goto": "EXFIL"}]},
        {"name": "CONSOLIDATION",
        ...
        {"name": "EXFIL",
         ...
         "done_when": ("any", [("all", [("squad_at", 0, LZ, 90), ("squad_at", 1, LZ, 90)]), ("steps", 195)]),
         "contingencies": []},
    ]
    return {"name": "HARMATTAN-2v3b%s (plan %s)" % ("-mech" if qrf == "mech" else "", variant), "phases": phases,
