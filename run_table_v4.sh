#!/bin/bash
# Table v4 : harnais v3 + DÉFENSE PRO (30+QRF12, skills montés, boucle de chasse). 16 serveurs, 7×16 ops.
# Difficulté par l'ADVERSAIRE, pas la géographie (principe gravé 07/06). Charge ~82 unités/serveur : surveiller le CPU.
SB=/mnt/data/harmattan-sandbox
PY=/mnt/steam/harmattan/venvs/rl/bin/python
N=16; REPS=16
OUT=/home/younes/arma3-marl/table_maneuvers_v4.jsonl
: > "$OUT"
...
for M in M1 M2 M3 M4 M5 M6 M7; do
  echo ""; echo "############ V4 MESURE $M ############"
  $PY run_maneuver.py --maneuver $M --servers $N --reps $REPS --out "$OUT" --max_steps 500 --enemy pro
done

echo ""; echo "############ SYNTHÈSE TABLE V4 ############"
$PY - <<'PYEOF'
import json, collections
rows = collections.defaultdict(list)
for line in open("/home/younes/arma3-marl/table_maneuvers_v4.jsonl"):
    r = json.loads(line)
...
PRED = {"M1":"30-55","M2":"25-50","M3":"10-35","M4":"10-30","M5":"20-45","M6":"15-40","M7":"5-25"}
