#!/usr/bin/env python3
"""reverdict_arc2 — LE VERDICT SURVIT-IL AU CONE QUI S'OUVRE ?
...
ap.add_argument("--out", default="reverdict_arc2.json")
a = ap.parse_args()
DEV = a.device
TAU_VERROU = 4.0
...
if __name__ == "__main__":
    ...
    print("    criteres 0606073790cc9c14 | doctrines scriptees | A=4 D=8 | graines 7,8,9", flush=True)
    ...
    ce = abs(dur["frontal_prise"] - 0.193) <= 0.08 and abs(dur["crochet_prise"] - 0.747) <= 0.08
    print("  CONTRE-EPREUVE (cone dur = banc fige : 19,3 %% / 74,7 %%, +-8 pts) : %s"
