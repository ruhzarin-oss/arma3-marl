#!/bin/bash
# BANC ALIZE 1 (HMT-39, 11/09/2026) : copie du lanceur CHACAL, mission separee ALIZE1.Altis,
# pour jouer en parallele de la campagne sans jamais toucher CHACAL.Altis.
...
MG_ASSAUT=$(lit mg_assaut 0); DELAI_PORTEUR=$(lit delai_porteur 45); APPUI_FIXE=$(lit appui_fixe 0); FEU_AVANT=$(lit feu_avant 0); APPUI_FEU=$(lit appui_feu 0); EFFECTIF=$(lit effectif 10); ACCESSIBLE=$(lit accessible 0); TENIR=$(lit tenir 0); HMG=$(lit hmg -1); ASSAUT_X=$(lit assaut_x 100)   # -1 = valeur du palier ; 100 = plafond inchange
...
DEP=/mnt/data/hmt/depot/bancs/alize1/mission.Altis
MPM="/mnt/c/Program Files (x86)/Steam/steamapps/common/Arma 3/MPMissions/ALIZE1.Altis"
