...
ORACLE=$(lit oracle 0); MG_ASSAUT=$(lit mg_assaut 0); DELAI_PORTEUR=$(lit delai_porteur 45); APPUI_FIXE=$(lit appui_fixe 0); FEU_AVANT=$(lit feu_avant 0); APPUI_FEU=$(lit appui_feu 0); EFFECTIF=$(lit effectif 10); ACCESSIBLE=$(lit accessible 0); TENIR=$(lit tenir 0); HMG=$(lit hmg -1); ASSAUT_X=$(lit assaut_x 100)   # -1 = valeur du palier ; 100 = plafond inchange
