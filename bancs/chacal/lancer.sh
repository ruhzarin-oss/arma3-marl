...
ecrire_param OBSERVATION "$OBSERVATION"; ecrire_param CONTROLE_PERCEPTION "$CONTROLE_PERCEPTION"; ecrire_param SONDE "$SONDE"; ecrire_param CONTROLE_DIST "$CONTROLE_DIST"
