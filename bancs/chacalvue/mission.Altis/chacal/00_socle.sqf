...
CHACAL_CONTROLE_PAS = ["CHACAL_CONTROLE_PAS", 10] call BIS_fnc_getParamValue;   // balayage : duree du regard par azimut ( origine 10 s )
CHACAL_CONTROLE_AZ = ["CHACAL_CONTROLE_AZ", 0] call BIS_fnc_getParamValue;   // banc, modes 7 et 8 : ecart d azimut cible / axe de la phase
