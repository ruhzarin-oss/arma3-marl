...
if (isServer) then {
    ...
    // EMPREINTE DU MONDE — missions + modset, en tete de journal a chaque demarrage.
    // Absente des 90 premiers accrochages : ils sont archives en partiels.
    (format ["HMT|G|EMPREINTE|%1|%2", "32d8afae55253299", str (getMissionConfigValue "")]) call HMT_LOG;
    HMT_A2PUR = false;
