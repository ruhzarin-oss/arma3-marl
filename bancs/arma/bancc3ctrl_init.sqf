...
if (isServer) then {
    ...
    HMT_CALIBRE = false;
    HMT_NDEF = 9;
    // CONTROLE POSITIF DU BANC : neuf defenseurs au lieu de treize, UN SEUL BRAS (le temoin).
    // Le balayage du 11/08 (1057 accrochages, ce monde) donne la survie a 63 pourcent a 13
    // defenseurs et 74 a 9 : +11 points, le calibre de la porte du lieu. On mesure ce que le
    // banc SAIT VOIR, pas ce que le geste vaut. ⟨CONTROLE_POSITIF_C3.md⟩
    HMT_CALIBRE = true;
    HMT_C3_CE = false;
