...
// ===== TEST DE FIABILITE DU VERDICT : le meme accrochage, trente fois. AUCUN generateur. =====
if (isServer) then {
    ...
    [] spawn { sleep 20; [112, 0.2] execVM "capture\\hmt_capture.sqf";
               sleep 15; [30] execVM "capture\\fiabilite_verdict.sqf"; };
};
