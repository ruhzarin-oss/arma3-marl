...
private _gw = createGroup west; private _ix=HMT_CX-55; private _iy=HMT_CY-95;
...
PERC = r'''
HMT_S=140; HMT_CX=5569; HMT_CY=4683; HMT_FOV=25; HMT_DR=70;
...
SMOKE = r'''HMT_CX=5569; HMT_CY=4683; "SmokeShellGreen" createVehicle [HMT_CX,HMT_CY,0]; diag_log "HARMATTAN_SUCCESS smoke";'''
